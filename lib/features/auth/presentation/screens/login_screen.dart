...
import 'package:ur_provider/features/auth/presentation/providers/auth_provider.dart';
import 'package:ur_provider/features/auth/presentation/providers/providers.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          const SizedBox(height: 50),
          Text('Login', style: textStyles!.headline4),
          ...
          SizedBox(
            ...
            child: CustomFilledButton(
              ...
              onPressed: loginForm.isPosting
                ...
                if (success) {
                  print(success);
                  if(loginForm.email.value.length<16){
                    context.go('/store/1/home');
                  }else
                    context.go('/supplier/1/home');
